    ...
    <div class="row">
        <div class="col-12">
            <div>
                ...
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Daily Invoice Report<span class="btn btn-info"> {{ date('d-m-Y',strtotime($sdate)) }}  </span> To <span class="btn btn-success"> {{ date('d-m-Y',strtotime($edate)) }} </span></strong></h3>
                </div>

...
<div class="page-content">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Credit Customer Report</li>
                        </ol>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Credit Customer Report</strong></h3>
                </div>
                <div class="">
                    <div class="table-responsive">
                        ...
                        @endforeach
                            ...
                            <tr>
                                ...
                                <td class="no-line text-end">${{ $total_due}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>

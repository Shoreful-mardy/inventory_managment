...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Customer Invoice No : ( <span class="text-danger">#{{$payment['invoice']['invoice_no']}} </span>)</strong></h3>
                </div>
                <div class="">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><strong>Customer Email</strong>
                                </td>
                            </tr>
                            </thead>
                            <tbody>
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control example-date-input" name="date" type="date" placeholder="MM-DD-YYY" id="date">
                            </div>
                        </div>
                        <div class="form-group col-md-3">

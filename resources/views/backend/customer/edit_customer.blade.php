...
<div class="col-12">
    <div class="card">
     ...
     <form method="post" action="{{ route('update.customer') }}" id="myForm" enctype="multipart/form-data">
                ...
                <input type="hidden" name="oldimg" value="{{ $customer->customer_image }}">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($customer->customer_image)) ? url($customer->customer_image) : url('upload/no_image.jpg') }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
